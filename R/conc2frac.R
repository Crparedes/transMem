#' Creates a data frame to be used as complete selfcontained transport data set
#'
#' The function transforms data from numeric vectors containing concentrations
#' in feed and strip solutions to a data frame that contains complete data
#' of transport process and can be used by several functions inside the
#' package. Output data frame can contain normalized fractions still remaining
#' in the feed and already transported to the strip phase, or the original
...
#' is inside a dataframe containing the information about the amount of given
#' species in both phases, the phase, and the transport time transcurred.
#'
